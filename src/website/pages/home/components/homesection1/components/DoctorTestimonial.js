...
const DoctorTestimonial = () => {
  ...
  return (
    <div className="ptpx60 pbpx60 md-ptpx30 md-pbpx30 sm-ptpx20 sm-pbpx20 bg-doctor">
      <div className="container mx-auto">
        <div className="flex sm-block justify-between items-center w-full">
          ...
          <div className="w-50 sm-w-full">
            ...
            >
              <SwiperSlide>
                <div className="d-shadow bgwhite rounded-10 doctor9-h prpx20 plpx20 ptpx20 pbpx20">
                  ...
                  <div className="flex items-center gap-4 mtpx20">
                    <img
                      ...
                      alt="doctor10-img"
                      className="doctor10-img object-contain"
                    />
